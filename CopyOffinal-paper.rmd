...
dat_stats_all %>%
  ...
  annotate("text",x=mean(recent_grads$Unemployment_rate) + 0.019,
           y=5, label="average", color="red", size=2.5) + 
  annotate("text",x=mean(recent_grads$Unemployment_rate) + 0.023,
           y=4.5, label="unemployment", color="red", size=2.5)
```
